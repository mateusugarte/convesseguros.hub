...
export default function DetalhesFicha({ id, onClose, onEdit, onDelete }) {
  ...
  if (!ficha) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-end animate-fade-in" style={{ backdropFilter: 'blur(16px) saturate(180%)', WebkitBackdropFilter: 'blur(16px) saturate(180%)', background: 'rgba(0,0,0,0.06)' }}>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-end animate-fade-in" style={{ backdropFilter: 'blur(16px) saturate(180%)', WebkitBackdropFilter: 'blur(16px) saturate(180%)', background: 'rgba(0,0,0,0.06)' }} onClick={onClose}>
      <div
        ...
        <div className="px-6 py-4 border-b border-dark-border flex items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0 flex-wrap justify-end">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-dark-border text-xs text-dark-muted hover:text-status-info hover:border-brand-accent/50 transition-colors"
