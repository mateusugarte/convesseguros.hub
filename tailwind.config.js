...
export default {
  ...
  theme: {
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%, 100%': { boxShadow: '0 0 0 0 rgba(0,0,121,0)' },
          '50%':      { boxShadow: '0 0 0 4px rgba(0,0,121,0.15)' },
        },
      },
      boxShadow: {
        'glow':      '0 0 20px rgba(0, 0, 121, 0.22)',
        'glow-sm':   '0 0 10px rgba(0, 0, 121, 0.14)',
        'glow-gold': '0 0 24px rgba(162, 214, 218, 0.28), 0 4px 12px rgba(162, 214, 218, 0.14)',
        'float':     '0 8px 32px -4px rgba(0,0,0,0.18), 0 2px 8px rgba(0,0,0,0.06)',
        'glow-blue': '0 0 24px rgba(0,0,121,0.20), 0 4px 12px rgba(0,0,121,0.10)',
        'modal':     '0 24px 64px rgba(0,0,0,0.32), 0 8px 24px rgba(0,0,121,0.16)',
      },
